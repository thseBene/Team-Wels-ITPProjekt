-- Import / Schema-Skript für das ERD (Benutzer, Thema, Kategorie, Feedback, Bild, feedback_kategorie, Notification)
...
-- Benutzer (ANGEPASST: mail, tel statt vorname, nachname - mit UNIQUE constraints)
...
-- -------------------------
-- Sequenzen / Identitys auf Max setzen (WICHTIG!)
-- -------------------------
...
-- WICHTIG: Sequenz für notification auch setzen!
