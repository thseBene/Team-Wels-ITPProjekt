...
function sendContactInfo(feedback) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const contactField = document.getElementById("inputContact");
        ...
        try {
            ...
            if (!response.ok) {
                ...
                try {
                    const created = yield response.json(); // falls Backend die Entity im Body zurückgibt
...
function sendFeedback(event) {
    ...
    <div id="contactContainer">
        ...
        <svg width="155" height="155" viewBox="0 0 155 155" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M112.494 112.199C112.494 112.199 114.029 114.019 114.809 114.957C115.588 115.894 116.969 117.999 116.969 117.999C119.988 121.797 119.334 124.396 119.334 124.396C118.392 125.161 117.543 125.571 116.946 125.8C116.255 126.066 114.991 126.448 113.558 127.153C113.297 127.279 112.742 127.596 112.672 128.016C112.606 128.431 112.933 128.767 112.933 128.767C112.933 128.767 115.616 132.201 116.418 133.032C117.221 133.862 116.656 135.477 116.656 135.477C116.656 135.477 118.028 134.026 115.839 136.419C113.656 138.813 90.812 167.12 90.812 167.12L125.778 167.172L124.527 147.347C124.527 147.347 124.63 146.88 125.306 145.891L127.7 166.962L127.709 167.209L146.018 167.302C146.018 167.302 146.722 167.377 146.708 166.864H146.722Z" fill="#0C3B6A" stroke="#0C3B6A" stroke-width="2" stroke-miterlimit="10"/>
        ...
        <p id="mayorText">
          Möchten sie Updates über den Status ihrer Rückmeldung?<br/>
        </p>
    ...
    `;
        ...
        (_b = document.getElementById("noThanksButton")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => sendOnlyFeedback(feedback));
    });
}
function sendOnlyFeedback(feedback) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const feedbackPayload = {
                subject: feedback.subject,
