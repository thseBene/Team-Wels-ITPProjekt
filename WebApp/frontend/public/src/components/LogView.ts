class LogView extends HTMLElement {
    ...
    render() {
        ...
        const formattedTimestamp = (() => {
            ...
            if (Number.isNaN(parsed)) return rawTs; // return original if unparsable
            d = new Date(parsed);
            }
        ...
        opacity: 0.6;
            ...
            <div class="logItem">
            ${
                this.getAttribute('action')?.toLowerCase().includes("login")
                    ...
                    : this.getAttribute('action')?.toLowerCase().includes("mail")
                    ...
                    : this.getAttribute('action')?.toLowerCase().includes("created")
