...
- README: weiter ausbauen (Screenshots, Architekturdiagramm)
- Tests: Integrationstests für Backend hinzufügen
- Deployment: CI-Workflow zum Bauen und Deployen ergänzen

---

Wenn du möchtest, füge ich noch Badges (Build, Coverage), Screenshots oder ein kurzes Architekturdiagramm hinzu. Bitte sag mir, welche Informationen du bevorzugst oder ob ich direkt commiten soll.